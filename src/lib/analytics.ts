...
export const EVENT = {
  ...
  adRewarded: "ad_rewarded", // { context: section | 'extra_pick' | 'streak_save' }
  ...
  // 앱 고유
  colorDiagnosed: "color_diagnosed", // { type_id }
  sectionUnlocked: "section_unlocked", // { section }
  dailyPickViewed: "daily_pick_viewed", // { type_id }
  extraPickRevealed: "extra_pick_revealed", // { type_id, index }
} as const;
